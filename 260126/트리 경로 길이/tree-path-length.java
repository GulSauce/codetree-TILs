...
class Solver {
    ...
    public Solver(int endNodeNumber, List<Edge> edgeList, List<Query> queryList) {
    ...
    private void lcaDist(int a, int b) {
        ...
        int diffA = height[a] - height[lca];
        int diffB = height[b] - height[lca];
        System.out.println(diffA + diffB + 1);
    }
