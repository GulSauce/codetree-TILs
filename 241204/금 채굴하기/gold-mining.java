    ...
    private static class Solver {
        ...
        int moveAndGetGoldCount(int x, int y, int moveCount){
            ...
            while (!q.isEmpty()){
                ...
                if(isInIndexRange(currentX + 1) && !isVisited[currentY][currentX+1]){
                ...
                if(isInIndexRange(currentY + 1) && !isVisited[currentY+1][currentX]){
        ...
        private boolean isInIndexRange(int i){
